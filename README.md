...
The YAP desktop version can be used with the YAP API Gateway to provide a full lifecycle API management platform. For more details, visit [https://youngapp.io](https://youngapp.io) and to see the full feature set, explore [https://manual.youngapp.co](https://manual.youngapp.co)
...
This SDK is distributed under the GNU General Public License v3.0. See [LICENSE.txt](LICENSE.txt) for more information.
